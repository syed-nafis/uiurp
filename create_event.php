...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    try {
        ...
        $createdBy = isset($_SESSION['user_id']) ? $_SESSION['user_id'] : 'anonymous';
        ...
        if ($result->getInsertedCount() > 0) {
            ...
            error_log("Event created successfully. ID: " . $result->getInsertedId());
...
<head>
    ...
    <title>Create Event - UIU Research Portal</title>
...
<body>
    ...
    <div class="main-container">
        ...
        <section class="page-header">
            <div class="container">
                <h1 class="page-title" data-aos="fade-up">Create Event</h1>
                <p class="page-subtitle" data-aos="fade-up" data-aos-delay="100">
                    Add a new event to the UIU research portal calendar
                </p>
            </div>
        </section>
            ...
            <?php if ($success): ?>
                <div class="alert alert-success mb-4" role="alert" data-aos="fade-up">
                    ...
                    <div class="mt-2">
                        ...
                        <a href="create_event.php" class="btn btn-sm btn-outline-success">Create Another Event</a>
                    </div>
                </div>
            <?php endif; ?>
                ...
                <form method="POST" action="" id="eventForm">
                    ...
                    <div class="form-section">
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-md-12 location-options physical-options">
                                <label for="room" class="form-label">Room/Location *</label>
                                <input type="text" class="form-control" id="room" name="room">
                            </div>
                            
                            <!-- Virtual Location Options -->
                            <div class="col-md-6 location-options virtual-options">
                                <label for="virtualPlatform" class="form-label">Virtual Platform *</label>
                                <input type="text" class="form-control" id="virtualPlatform" name="virtualPlatform" placeholder="Zoom, Google Meet, etc.">
                            </div>
                            <div class="col-md-6 location-options virtual-options">
                                <label for="joinLink" class="form-label">Join Link</label>
                                <input type="url" class="form-control" id="joinLink" name="joinLink" placeholder="https://">
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row g-4">
                            <div class="col-md-12">
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox" role="switch" id="registrationRequired" name="registrationRequired">
                                    <label class="form-check-label" for="registrationRequired">Registration Required</label>
                                </div>
                            </div>
                            
                            <div class="col-md-6 registration-options">
                                <label for="registrationLink" class="form-label">Registration Link *</label>
                                <input type="url" class="form-control" id="registrationLink" name="registrationLink" placeholder="https://">
                            </div>
                            <div class="col-md-6 registration-options">
                    ...
                    <div class="form-section">
                        ...
                        <div class="speakers-container" id="speakersContainer"></div>
                    ...
                    <div class="row g-4 mt-4">
                        <div class="col-md-12 text-center">
                            ...
                            <a href="events.php" class="btn btn-cancel">
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Add the first speaker by default
            if (speakerCount === 0) {
