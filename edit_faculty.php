    ...
    <div class="card shadow p-4">
        ...
        <form method="POST" action="update_faculty.php" enctype="multipart/form-data">
            ...
            <div class="mb-4">
                ...
                <div id="projectsContainer">
                    <?php if (!empty($projects)): ?>
                        <?php foreach ($projects as $index => $project): ?>
                            ...
                            <div class="mb-3 border rounded p-3 bg-light project-block">
                ...
                <!-- Add Project Button -->
                <button type="button" class="btn btn-outline-primary mt-3" id="addProjectBtn">+ Add Project</button>
            </div>



            <!-- Prerequisites -->
            <div class="mb-4"> <h5 class="mb-3">Prerequisites (comma-separated):</h5>
            ...
            <div class="mb-4">
                ...
                <div id="resourcesContainer">
                    <?php if (!empty($resources) && is_array($resources)): ?>
                        <?php foreach ($resources as $index => $res): ?>
                            ...
                            <div class="mb-3 border rounded p-3 bg-light resource-block">
                ...
                <!-- Add Resource Button -->
                <button type="button" class="btn btn-outline-primary mt-3" id="addResourceBtn">+ Add Resource</button>
            </div>


            <!-- Submit Button -->
            <div class="text-center">
                <button type="submit" class="btn btn-primary px-4">Update Informatio</button>
            </div>
        </form>
    </div>
</div>
